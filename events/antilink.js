        ...
        if (linkRegex.test(message.content)) {
            ...
            if (containsBadLink) {
                try {
                    ...
                    const warning = await message.channel.send(`⚠️ ${message.author}, kamu tidak diizinkan mengirim sembarang link di server Jawa Party! Hanya link TikTok dan Roblox Share tertentu yang diperbolehkan.`);
